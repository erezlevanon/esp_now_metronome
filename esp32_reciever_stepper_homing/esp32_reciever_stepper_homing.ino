...
float targetPosition = 117;  //the PID will try to reach this value. In this example it is the total angle
...
void driveMotor() {
    ...
    */
    ...
    if (fabs(controlSignal) > 0.2)  //we are within +/- 1 degrees of the target, can be fine tuned
    {
        ...
        stepper.setSpeed(controlSignal * 20);  //Accelstepper way; The multiplier depends on the desired response speed
